...
const CartSvgIcon = () => (
  <svg width="16" height="15" viewBox="0 0 18 17" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ flexShrink: 0 }}>
    <path d="M1 1h2.8l2 9h8.4l1.8-6H4.6" />
      ...
      <div className="modal product-modal">
        ...
        <div className="modal-actions">
          ...
          {onAddToCart && (
            ...
            >
              <CartSvgIcon /> Agregar al carrito
            </button>
          )}
        </div>
